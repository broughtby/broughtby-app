...
export const bookingAPI = {
  ...
  duplicateBooking: (id) => api.post(`/bookings/${id}/duplicate`),
  updateDraftBooking: (id, data) => api.put(`/bookings/${id}/draft`, data),
  sendDraftBooking: (id) => api.post(`/bookings/${id}/send`),
...
export const adminAPI = {
  ...
  getAllUsersWithStatus: (role) => api.get('/admin/users/status', { params: { role } }),
